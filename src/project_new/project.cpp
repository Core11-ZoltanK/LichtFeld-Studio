...
namespace lfs::project {
    ...
    DataSetInfo::DataSetInfo(const lfs::core::param::DatasetConfig& data_config) : DatasetConfig(data_config) {
        if (data_path.empty()) {
            data_type = "";
        } else {
    ...
    ProjectData Project::parseProjectData(const nlohmann::json& json) const {
        ...
        // Parse data section
        const auto& dataJson = json["data"];
        lfs::core::param::DatasetConfig data_set = lfs::core::param::DatasetConfig::from_json(dataJson);
        (lfs::core::param::DatasetConfig&)data.data_set_info = data_set;
        ...
        if (json.contains("training") && json["training"].contains("optimization")) {
            data.optimization = lfs::core::param::OptimizationParameters::from_json(json["training"]["optimization"]);
        }
    ...
    nlohmann::ordered_json Project::serializeProjectData(const ProjectData& data) const {
        ...
        // Data section
        json["data"] = static_cast<lfs::core::param::DatasetConfig>(data.data_set_info).to_json();
    ...
    void Project::setDataInfo(const lfs::core::param::DatasetConfig& data_config) {
    ...
    std::shared_ptr<Project> CreateNewProject(const lfs::core::param::DatasetConfig& data,
                                              const lfs::core::param::OptimizationParameters& opt,
                                              const std::string& project_name,
                                              bool update_file_on_change) {

        auto project = std::make_shared<lfs::project::Project>(update_file_on_change);
    ...
    std::shared_ptr<Project> CreateTempNewProject(const lfs::core::param::DatasetConfig& data,
                                                  const lfs::core::param::OptimizationParameters& opt,
                                                  const std::string& project_name, bool udpdate_file_on_change) {
        namespace fs = std::filesystem;
        lfs::core::param::DatasetConfig data_with_temp_output = data;
