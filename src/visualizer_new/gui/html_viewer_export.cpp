...
namespace lfs::vis::gui {
    ...
    namespace {
        ...
        std::string replace_placeholder(const std::string_view input, const std::string_view placeholder, const std::string_view replacement) {
            std::string result;
        ...
        std::string pad_text(const std::string_view text, const int spaces) {
            std::string result;
        ...
        std::string generate_html(const std::string& base64_sog) {
            ...
            // Replace content fetch with base64 data URL
    ...
    std::expected<void, std::string> export_html_viewer(
        ...
        const lfs::core::SogWriteOptions sog_options{
            .iterations = 10,
            .use_gpu = true,
        ...
        if (auto result = lfs::core::write_sog(splat_data, sog_options); !result) {
