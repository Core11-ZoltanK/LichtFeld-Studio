...
class AdcStrategyTensorOpsTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(AdcStrategyTensorOpsTest, Zeros_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, ZerosBool_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, OnesBool_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, Empty_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, Randn_ShapeMatch) {
...
TEST_F(AdcStrategyTensorOpsTest, FromVector_Int) {
...
TEST_F(AdcStrategyTensorOpsTest, NonzeroSqueeze_BasicPattern) {
...
TEST_F(AdcStrategyTensorOpsTest, NonzeroSqueeze_AllTrue) {
...
TEST_F(AdcStrategyTensorOpsTest, NonzeroSqueeze_AllFalse) {
...
TEST_F(AdcStrategyTensorOpsTest, Slice_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, Slice_2D) {
...
TEST_F(AdcStrategyTensorOpsTest, IndexSelect_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, IndexSelect_1D) {
...
TEST_F(AdcStrategyTensorOpsTest, IndexPut_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, IndexPut_Bool) {
...
TEST_F(AdcStrategyTensorOpsTest, LogicalAnd_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, LogicalAnd_Large) {
...
TEST_F(AdcStrategyTensorOpsTest, LogicalOr_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, LogicalNot_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, LogicalChain_GrowGsPattern) {
...
TEST_F(AdcStrategyTensorOpsTest, Sum_Scalar) {
...
TEST_F(AdcStrategyTensorOpsTest, Sum_BoolToInt) {
...
TEST_F(AdcStrategyTensorOpsTest, Sum_AlongDim) {
...
TEST_F(AdcStrategyTensorOpsTest, Max_AlongDim) {
...
TEST_F(AdcStrategyTensorOpsTest, ClampMin_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, ClampMaxInplace_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, DivisionWithClamp_GradPattern) {
...
TEST_F(AdcStrategyTensorOpsTest, Cat_1D) {
...
TEST_F(AdcStrategyTensorOpsTest, Cat_2D) {
...
TEST_F(AdcStrategyTensorOpsTest, Cat_Bool) {
...
TEST_F(AdcStrategyTensorOpsTest, Reshape_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, Reshape_SH0Pattern) {
...
TEST_F(AdcStrategyTensorOpsTest, AppendGather_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, AppendZeros_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, AppendZeros_1D) {
...
TEST_F(AdcStrategyTensorOpsTest, ZeroInplace_Basic) {
...
TEST_F(AdcStrategyTensorOpsTest, DuplicatePattern_Full) {
...
TEST_F(AdcStrategyTensorOpsTest, RemovePattern_Full) {
...
TEST_F(AdcStrategyTensorOpsTest, PruneGsPattern_Full) {
...
TEST_F(AdcStrategyTensorOpsTest, GrowGsCapEnforcement_Full) {
...
TEST_F(AdcStrategyTensorOpsTest, FillFreeSlotsPattern) {
...
TEST_F(AdcStrategyTensorOpsTest, ActiveCountPattern) {
...
TEST_F(AdcStrategyTensorOpsTest, GetActiveIndicesPattern) {
...
TEST_F(AdcStrategyTensorOpsTest, DensificationInfo_SubscriptOperator) {
...
TEST_F(AdcStrategyTensorOpsTest, DensificationInfo_FullGrowGsPattern) {
...
TEST_F(AdcStrategyTensorOpsTest, DensificationInfo_ResetAfterRefine) {
...
TEST_F(AdcStrategyTensorOpsTest, Pruning_CompletePruneGsChain) {
...
TEST_F(AdcStrategyTensorOpsTest, Pruning_RemoveAndZeroOptimizer) {
...
TEST_F(AdcStrategyTensorOpsTest, Pruning_LargeScale) {
...
TEST_F(AdcStrategyTensorOpsTest, FillFreeSlots_IndexPutIndexSelect) {
...
TEST_F(AdcStrategyTensorOpsTest, Split_AppendZerosThenIndexPut) {
...
TEST_F(AdcStrategyTensorOpsTest, GrowGs_FullMaskCalculation) {
...
TEST_F(AdcStrategyTensorOpsTest, PruneGs_FullMaskCalculation) {
...
TEST_F(AdcStrategyTensorOpsTest, Remove_ZeroRotationAndOptimizerState) {
    // Pattern from remove():
...
TEST_F(AdcStrategyTensorOpsTest, ResetOpacity_ClampAndZero) {
...
TEST_F(AdcStrategyTensorOpsTest, MaxCapEnforcement_LimitMaskBySlice) {
...
TEST_F(AdcStrategyTensorOpsTest, LargeScale_Densification) {
...
TEST_F(AdcStrategyTensorOpsTest, LargeScale_IndexSelect) {
...
TEST_F(AdcStrategyTensorOpsTest, LargeScale_IndexPut) {
