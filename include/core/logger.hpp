...
#define LOG_PERF(...) \
    ::gs::core::Logger::get().log_internal(::gs::core::LogLevel::Performance, std::source_location::current(), __VA_ARGS__)
...
#define LOG_TIMER_DEBUG(name) ::gs::core::ScopedTimer _timer##__LINE__(name, ::gs::core::LogLevel::Debug)
